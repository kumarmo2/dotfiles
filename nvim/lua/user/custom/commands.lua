...
toggle_cmd = function()
  local curr_cmd_height = vim.o.cmdheight
  if curr_cmd_height == nil or curr_cmd_height == 0 then
...
api.nvim_create_user_command("ToggleCMD", "lua toggle_cmd()", {})
-- TODO/NOTE:  this wasn't working fine with catppuccin colorscheme
-- TODO: need to make this work in a generic way.
